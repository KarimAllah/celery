...
class Consumer(object):
    ...
    def start(self):
        ...
        while self._state != CLOSE:
            try:
                self.reset_connection(initial=initial)
    ...
    def reset_connection(self, initial=False):
        ...
        self.connection = self._open_connection(initial=initial)
    ...
    def _open_connection(self, initial=False):
        ...
        # until it's needed.
        conn = self.app.broker_connection(next_connection=not initial)
